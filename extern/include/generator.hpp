...
#ifndef EXTERN_GENERATOR_HPP
#define EXTERN_GENERATOR_HPP
//from https://wg21.link/p2168r0
...
constexpr inline bool std::ranges::enable_view<Util::generator<T, U>> = true;
#endif

#endif //EXTERN_GENERATOR_HPP
